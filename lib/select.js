...
const CATEGORY_RULES = [
  ...
  { category: "문화", terms: ["문화", "문화재", "유산", "전시", "미술", "박물관", "도서", "출판", "공연예술", "건축"] },
...
function normalizeCategory(value, video) {
  ...
  if (/문화|예술|도서|전시/.test(text)) return "문화";
...
- For every selected video, assign category as exactly one of: 국제, 경제, 사회, 사건·재난, 건강, 정책, 문화, 생활.
- score is IMPORTANCE for today's viewer, not confidence. Use an integer 0-100. Major national/international developments should score higher than useful but lower-impact lifestyle or culture items.
